...
settings-llm-thinking-desc = Рассуждающие модели сначала думают, и это занимает секунды. Выключение работает через директиву в промпте и поддерживается не всеми моделями.
