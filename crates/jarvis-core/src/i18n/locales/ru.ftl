...
settings-wake-word-desc = Выберите нейросеть, которая слушает имя. Смена действует сразу, со следующей вашей фразы.
settings-wake-score = Строгость активации
settings-wake-score-desc = Насколько точно должно совпасть слово-активатор. Подбирается по логу, а не на глаз: там на каждую попытку пишется набранный балл и порог, который надо было взять. Ниже — реагирует охотнее, но чаще на чужую речь; выше — приходится звать дважды, и начало команды теряется. От 30 до 95, по умолчанию 62. Работает для Rustpotter.
...
settings-stt-desc = Что расшифровывает сказанное ПОСЛЕ слова-активатора. Само слово «Джарвис» всегда ловит Vosk и этот выбор его не касается: там нужен словарь из восьми слов, иначе пришлось бы круглосуточно расшифровывать все звуки в комнате. Смена действует сразу, со следующей вашей фразы.
...
settings-dialogue-exit = Пауза до выхода из диалога
settings-dialogue-exit-desc = Сколько секунд молчания завершают разговор, начатый словами «давай поговорим». Отсчёт идёт с того момента, как ассистент договорил. Выйти можно и вслух: «стоп», «хватит», «всё», «до свидания». Внутри диалога команды не выполняются — всё сказанное уходит к языковой модели, и заготовки вроде «думаю над ответом» не проигрываются.
...
settings-duck-level-desc = Сколько процентов прежней громкости остаётся у остальных. Меньше — тише: 20 примерно как делает сама Windows во время звонка, 0 — полная тишина. Больше почти ничего не меняет: на 80 разница всего два децибела, её не слышно. Если Джарвиса перекрывает музыка, начните с 10-20. От 0 до 90.
settings-voice-volume = Громкость голоса
settings-voice-volume-desc = Насколько громко звучит сам Джарвис. 100 — как записано. Записи сделаны почти под потолок, поэтому выше 150 самые громкие фразы могут захрипеть — запаса там немного. Если Джарвиса заглушает музыка, сначала убавьте «Насколько тише»: там запас куда больше. От 50 до 200.
