...
settings-wake-word-desc = Виберіть нейромережу для розпізнавання активаційної фрази. Зміна набуває чинності з наступним запуском.
...
settings-stt-desc = Що розшифровує сказане ПІСЛЯ слова-активатора. Саме слово «Джарвіс» завжди ловить Vosk, і цей вибір його не стосується: там потрібен словник із восьми слів, інакше довелося б цілодобово розшифровувати всі звуки в кімнаті. Зміна набуває чинності з наступним запуском.
...
settings-duck-level-desc = Скільки відсотків попередньої гучності лишається. 20 — приблизно як робить сама Windows під час дзвінка. 0 — повна тиша. Від 0 до 90.
