...
settings-llm-max-tokens-desc = Загальний бюджет на відповідь. Моделі з міркуванням витрачають його й на роздуми, тож за порожніх відповідей його варто підняти. Від 64 до 32768.
settings-llm-thinking = Міркування моделі
settings-llm-thinking-desc = Моделі з міркуванням спершу думають, і це триває секунди. Вимкнення працює через директиву в промпті й підтримується не всіма моделями.
