...
settings-llm-thinking-desc = Reasoning models think first, which takes seconds. Turning it off works through a prompt directive and not every model honours it.
